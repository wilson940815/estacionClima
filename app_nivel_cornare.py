...
# ============================================================
# 🟢 NUEVO 1: CONFIGURACIÓN DE ALERTAS
# ============================================================
...
if consultar:
    ...
    if error:
        ...
        if not registros:
            ...
            # ========================================================
            # 🟢 NUEVO 2: DETECCIÓN DE PICOS ALTOS Y BAJOS
            # ========================================================
            ...
            # ------------------------------------------------------------------
            # Coordenadas e índice de calidad
            # ------------------------------------------------------------------
            ...
            # ========================================================
            # 🟢 NUEVO 3: ALERTAS DE NIVEL ALTO Y BAJO
            # ========================================================
            ...
            # ========================================================
            # 🟢 NUEVO 4: GRÁFICO CON LÍMITES DE ALERTA
            # ========================================================
            ...
            # Línea que muestra el límite alto
            grafico["Alerta alta"] = nivel_alto

            # Línea que muestra el límite bajo
            ...
            # ========================================================
            # 🟢 NUEVO 5: TABLAS DE PICOS ALTOS Y BAJOS
            # ========================================================
            ...
            # ========================================================
            # 🟢 NUEVO 6: RESUMEN AUTOMÁTICO DE LOS DATOS
            # ========================================================
            ...
            st.write(
                ...
                **{len(df)} lecturas**.
                ...
                El nivel promedio fue de
                **{nivel_promedio:.2f}**.

                El nivel máximo fue de
                **{nivel_maximo:.2f}** y se registró el
                **{fecha_maximo}**.
